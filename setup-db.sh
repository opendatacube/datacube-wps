...
if [ ! -f dump.sql ]; then
   ...
   for x in ga_ls8c_ard_3 ga_ls7e_ard_3 ga_ls5t_ard_3; do $cmd product add $index/products/$x.odc-product.yaml; done
   ...
   {
       stac "ga_ls8c_ard_3,ga_ls7e_ard_3" 2019-03-01 2019-08-01 "146.65,-36.16,147.29,-35.66"
