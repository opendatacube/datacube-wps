...
docker-compose exec -T index bash -c "tail -n+2 product_list.csv | grep 'wofs_albers\|ls._fc_albers\|mangrove_cover\|ga_ls_fc_3' | awk -F , '{print \$2}' | xargs datacube -v product add"
